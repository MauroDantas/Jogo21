    ...
    public partial class Form1 : Form
    {
        ...
        private void pictureBox7_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                nmrBaralho = rnd.Next(1, 4);
                pictureBox7.Load("baralho" + nmrBaralho + "-" + n7 + ".png");
                TotalJog = int.Parse(lblJogador.Text) + n7;
            }
            ...
            if (TotalJog > 21)
            {
                MessageBox.Show("Estorou os 21 pontos!! você perdeu pra máquina kkkkk!!");
        ...
        private void pictureBox8_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                nmrBaralho = rnd.Next(1, 4);
                pictureBox8.Load("baralho" + nmrBaralho + "-" + n8 + ".png");
                TotalJog = int.Parse(lblJogador.Text) + n8;
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Parabéns Você Ganhou! Você pontuou melhor que o computador. Jogue novamente ...");
                resetar();
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            if (TotalJog > 21)
            {
                MessageBox.Show("Estourou!! você perdeu pra máquina kkkkk!");
                resetar();
        ...
        private void pictureBox6_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                nmrBaralho = rnd.Next(1, 4);
                pictureBox6.Load("baralho" + nmrBaralho + "-" + n6 + ".png");
                TotalJog = int.Parse(lblJogador.Text) + n6;
            }
